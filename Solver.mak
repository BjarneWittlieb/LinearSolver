...
Solver.exe : Solver.o Matrix.o Vector.o Tuple.o Random.o RNG.o Rotate.o Matrix_Util.o Matrix_Rotate.o
	gcc -o Solver.exe Solver.o Matrix.o Vector.o Tuple.o Random.o RNG.o Rotate.o Matrix_Util.o Matrix_Rotate.o -lm
